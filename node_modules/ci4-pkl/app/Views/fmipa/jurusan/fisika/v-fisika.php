...
<div class="container col-md mt-4">
    ...
    <div class="container-responsive">
        <!-- Icon Cards-->
        <div class="row mb-3">
            <a href="/fisika" class="hidden-xs inline logo ml-3 justify-content-start">
                <h4>Jurusan Fisika</h4>
            </a>
        </div>
        <div class="row">
            ...
            <div class="col-xl-4 col-sm-6 mb-2">
                <div class="card text-white bg-success o-hidden h-100">
                    <div class="card-body">
                        ...
                        <div class="mr-5">S1 Fisika</div>
                    </div>

                    <a class="card-footer text-white clearfix small z-1" href="/fisika/mahasiswa/S1-fisika">
                        <span class=" float-left">Lihat Detail</span>
                        <span class="float-right">
                            <i class="fas fa-angle-right"></i>
                        </span>
