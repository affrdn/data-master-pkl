...
<div class="container-fluid mt-3">
    <div class="row mb-1">
        <div class="col d-flex justify-content-between">
            <a href="/data/dosen" class="hidden-xs inline logo">
    ...
    <div class="row row-responsive">
        <div class="col d-flex justify-content-between mb-3">
            <form action="/data/dosen/" method="POST" enctype="multipart/form-data">
                <div class="input-group input-group-sm align-self-center">
                    ...
                    <div class="input-group-append">
                        <button class="btn btn-sm btn-outline-info" type="submit" name="submit" data-placement="bottom" title="Cari">
            ...
            <div class="col-sm align-self-center d-flex align-items-end flex-column">
                <?php if (session()->get('isLoggedIn')) : ?>
                    <a href="/data/mahasiswa/create" class="btn btn-sm btn-info">
                        ...
                        <?php foreach ($dosen as $d) : ?>
                            ...
                            <tr class="d-flex justify-content-start small z-1">
                                ...
                                <td class="ml-auto align-self-center">
                                    ...
                                    <?php if (session()->get('isLoggedIn')) : ?>
                                        <a href="/data/mahasiswa/edit/<?= $d['nip_dosen']; ?>">
                                        ...
                                        <a onclick="return confirm('Anda yakin ingin menghapus data <?= $d['nip_dosen']; ?> ?')" href="/data/mahasiswa/delete/<?= $m['npm_mhs']; ?>">
...
<!-- Modal -->
<?php foreach ($dosen as $d) : ?>
    <div class="modal fade" id="tester<?= $d['nip_dosen']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
